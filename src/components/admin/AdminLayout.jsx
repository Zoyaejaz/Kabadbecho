      ...
      <header className="fixed top-0 left-0 right-0 h-16 bg-white shadow-md z-40 flex items-center px-4 lg:px-6">
        ...
        <div className="ml-auto flex items-center gap-4">
          <div className="text-right hidden sm:block">
            <p className="text-sm font-semibold text-[#5D4037]">{localStorage.getItem('name') || 'Admin'}</p>
            <p className="text-xs text-gray-500">{localStorage.getItem('email') || 'admin@kabadbecho.com'}</p>
          </div>
          <button 
